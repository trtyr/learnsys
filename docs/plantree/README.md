...
| [lms](plans/lms/README.md) | 🟢 Done | P0/P1/P2 全落地 | decision 005 (card-first) | 语义搜索（Deferred） |
...
- `lms`：`execute-ready`（P0/P1/P2 全落地，见 [decision 005](plans/lms/decisions/005-card-first-content-focus.md)）
